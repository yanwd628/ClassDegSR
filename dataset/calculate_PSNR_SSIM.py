...
def main():
    ...
    folder_GT = '/root/yanwd/ClassDegSR/Results/no_joint_train/SR'
    folder_Gen = '/root/yanwd/ClassDegSR/data/Test_4x/HR'

    res_path = "/root/yanwd/ClassDegSR/Results/no_joint_train/test_SR_HR_res.txt"
